...
function Navbar() {
  ...
  return (
    <>
        <div className={`max-w-screen-2xl containermx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 ease-in-out":""}`}>
        <div className="navbar">
                ...
                <div className="navbar-end space-x-3">
                 ...
                 { /* <label className="swap swap-rotate">
                    ...
                    <div>
                        <a className="bg-slate-700 text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
